...
<div class="container" style="margin-top:30px">
    <div class="row">
      ...
      <br\> 
      <br\>
      <h1 class="text-center">FOODSEL COMPANY</h1>
        <p>Selamat datang di FoodSel Company</p>
        <p> Office : Jl. Sukasari RT.03 RW.14 Majalaya-Rancaekek</p>
        <p>Whatsap : 085864552320</p>
        <p>emal : selparizqi@gmal.com</p>

        <p></p>
        <p></p>
        <p>Terimakasih sudah berkunjung ke website kami</p>
    </div>
</div>
