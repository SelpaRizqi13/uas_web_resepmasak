...
while ($row = $res1->fetch_assoc()) {
  $output .= '
    <div class="media border p-3 mb-2">
      <img src="img/avatar1.png" alt="foto-user" class="mr-3 mt-3 rounded-circle" style="width:60px;">
    ...
    while ($row = $res1->fetch_assoc()) {
      $output .= '
        <div class="media border p-3 mb-2" style="margin-left:'.$marginleft.'px">
          <img src="img/avatar2.png" alt="foto-user" class="mr-3 mt-3 rounded-circle" style="width:60px;">
          <div class="media-body">
          <div class="row">
            <div class="col-sm-10">
              <h4><b>'.$row["nama_pengirim"] .'</b> <small> Posted on <i>'.$row["date"].'</i></small></h4>
